...
public class RuntimeStyleActivity extends AppCompatActivity {
  ...
  private void setLayerInvisible() {
    ...
    for (String roadLayer : roadLayers) {
      mapboxMap.getLayer(roadLayer, new Callback<Layer>() {
        @Override
  ...
  private void setBackgroundOpacity() {
    mapboxMap.getLayer("background", new Callback<Layer>() {
      @Override
      public void onResult(Layer layer) {
        if (layer != null) {
  ...
  private void setWaterColor() {
    mapboxMap.getLayer("water", new Callback<Layer>() {
      @Override
  ...
  private void addParksLayer() {
    ...
    mapboxMap.getLayer("parksLayer", new Callback<Layer>() {
      @Override
      public void onResult(Layer layer) {
    ...
    mapboxMap.getLayerAs("parksLayer", new Callback.LayerCallback<FillLayer>() {
      @Override
  ...
  private void animateParksSource(final FeatureCollection parks, final int counter) {
    ...
    handler.postDelayed(new Runnable() {
      ...
      public void run() {
        ...
        // change the source
        mapboxMap.getSourceAs("dynamic-park-source", new Callback.SourceCallback<GeoJsonSource>() {
          @Override
  ...
  private void addTerrainLayer() {
    ...
    try {
      ...
      mapboxMap.getLayerAs("terrainLayer", new Callback.LayerCallback<LineLayer>() {
        @Override
        public void onResult(LineLayer layer) {
          ...
          mapboxMap.getLayer("terrainLayer", new Callback<Layer>() {
            @Override
            public void onResult(Layer layer) {
  ...
  private void styleFillFilterLayer() {
    ...
    handler.postDelayed(new Runnable() {
      ...
      public void run() {
        ...
        mapboxMap.getLayer("states", new Callback<Layer>() {
          @Override
          public void onResult(Layer layer) {
  ...
  private void styleLineFilterLayer() {
    ...
    handler.postDelayed(new Runnable() {
      ...
      public void run() {
        ...
        mapboxMap.getLayer("counties", new Callback<Layer>() {
          @Override
          public void onResult(Layer layer) {
  ...
  private void styleNumericFillLayer() {
    ...
    handler.postDelayed(new Runnable() {
      ...
      public void run() {
        ...
        mapboxMap.getLayer("regions", new Callback<Layer>() {
          @Override
          public void onResult(Layer layer) {
