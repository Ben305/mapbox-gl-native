...
public class MarkerViewActivity extends AppCompatActivity {
    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        MarkerViewActivity.this.mapboxMap.addMarker(new MarkerOptions()
            .title("United States")
            .position(new LatLng(38.902580, -77.050102)), new Callback<Marker>() {
            @Override
        ...
        MarkerViewActivity.this.mapboxMap.addMarker(new MarkerViewOptions()
            ...
            .icon(IconFactory.getInstance(mapView.getContext())
              .fromResource(R.drawable.ic_android)), new Callback<MarkerView>() {
            @Override
            public void onResult(MarkerView markerView) {
        ...
        mapboxMap.addMarker(new MarkerViewOptions()
            ...
            .icon(IconFactory.getInstance(mapView.getContext())
              .fromResource(R.drawable.ic_android_2)), new Callback<MarkerView>() {
            @Override
            public void onResult(MarkerView markerView) {
        ...
        mapboxMap.addMarker(new MarkerOptions()
          ...
          .title("InfoWindow")
          .snippet("Offscreen, to the right of the Map."), new Callback<Marker>() {
          @Override
          public void onResult(Marker marker) {
        ...
        mapboxMap.addMarker(new MarkerOptions()
          ...
          .title("InfoWindow")
          .snippet("Offscreen, to the bottom of the Map"), new Callback<Marker>() {
          @Override
          public void onResult(Marker marker) {
            mapboxMap.selectMarker(marker);
          }
  ...
  private class MoveMarkerRunnable implements Runnable {
    @Override
    public void run() {
      if (movingMarkerTwo != null && movingMarkerOne != null) {
